...
if (isset($_GET['token']) && isset($_GET['email'])) {
    ...
    $query = "SELECT * FROM users WHERE email = '$email' AND verification_token = '$token' LIMIT 1";
...
<head>
    ...
    <title>Email Verification - H&M</title>
    <!-- Bootstrap CSS -->
...
<body>
    <div class="verify-card">
        <a href="home.php">
            <svg class="logo" viewBox="0 0 200 132" xmlns="http://www.w3.org/2000/svg">
        ...
        <?php else: ?>
            ...
            <p class="message"><?php echo htmlspecialchars($message); ?></p>
            <a href="register.php" class="btn-primary">BACK TO REGISTER</a>
        <?php endif; ?>
    </div>
