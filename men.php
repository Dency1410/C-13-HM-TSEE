...
$categories_query = "SELECT * FROM categories WHERE gender='Men' ORDER BY name ASC";
...
// Build products query for 'Men' gender
$query = "SELECT p.*, c.name as category_name 
          FROM products p 
          LEFT JOIN categories c ON p.category_id = c.id 
          WHERE p.gender = 'Men'";

// The `category` URL parameter now represents the category ID, not a slug.
if (!empty($category_slug)) {
    // We treat category_slug as ID (renamed variable conceptually but kept for scope safety)
...
// Find the category title if filtered
...
<body>
    ...
    <div class="side-panel" id="ladiesSidePanel">
        ...
        <ul class="side-panel-menu">
            <li><a href="ladies.php?category=tops">Tops</a></li>
            <li><a href="ladies.php?category=jeans">Jeans</a></li>
            <li><a href="ladies.php?category=dresses">Dresses</a></li>
            <li><a href="ladies.php?category=jackets">Jackets & Coats</a></li>
            <li><a href="ladies.php?category=sweatshirts">Sweatshirts & Hoodies</a></li>
            <li><a href="ladies.php?category=skirts">Skirts</a></li>
            <li><a href="ladies.php?category=shirts">Shirts</a></li>
            <li><a href="ladies.php?category=shorts">Shorts</a></li>
            <li><a href="ladies.php?category=blazers">Blazer & Waistcoats</a></li>
            <li><a href="ladies.php?category=jumpsuits">Jumpsuits</a></li>
        </ul>
    </div>
    ...
    <div class="side-panel" id="menSidePanel">
        ...
        <ul class="side-panel-menu">
            <li><a href="men.php?category=jackets">Jackets & Coats</a></li>
            <li><a href="men.php?category=hoodies">Hoodies & Sweatshirts</a></li>
            <li><a href="men.php?category=tshirts">T-shirts</a></li>
            <li><a href="men.php?category=polos">Polos</a></li>
            <li><a href="men.php?category=shirts">Shirts</a></li>
            <li><a href="men.php?category=blazers">Blazer & Suits</a></li>
            <li><a href="men.php?category=shorts">Shorts</a></li>
            <li><a href="men.php?category=jeans">Jeans</a></li>
            <li><a href="men.php?category=sweatpants">Sweatpants</a></li>
            <li><a href="men.php?category=trousers">Trousers</a></li>
        </ul>
    </div>
            ...
            <div class="kids-columns">
                <div class="kids-column">
                    ...
                    <ul class="kids-column-menu">
                        <li><a href="kids.php?gender=girl&category=dresses">Dresses</a></li>
                        <li><a href="kids.php?gender=girl&category=jeans">Jeans</a></li>
                        <li><a href="kids.php?gender=girl&category=tshirts">T-shirts</a></li>
                        <li><a href="kids.php?gender=girl&category=shorts">Shorts</a></li>
                        <li><a href="kids.php?gender=girl&category=jumpsuits">Jumpsuits & playsuits</a></li>
                    </ul>
                </div>
                ...
                <div class="kids-column">
                    ...
                    <ul class="kids-column-menu">
                        <li><a href="kids.php?gender=boy&category=tshirts">Tshirts & shirts</a></li>
                        <li><a href="kids.php?gender=boy&category=jeans">Jeans</a></li>
                        <li><a href="kids.php?gender=boy&category=shorts">Shorts</a></li>
                        <li><a href="kids.php?gender=boy&category=trousers">Trousers</a></li>
                        <li><a href="kids.php?gender=boy&category=sweaters">Sweaters & sweatshirts</a></li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="men-page-container">
        ...
        <aside class="category-sidebar">
            ...
            <ul class="category-list">
                <li><a href="men.php" class="<?= empty($category_slug) ? 'active' : '' ?>">All Products</a></li>
                <?php foreach($categories as $cat): ?>
                    <li><a href="men.php?category=<?= $cat['id'] ?>" class="<?= $category_slug == $cat['id'] ? 'active' : '' ?>"><?= htmlspecialchars($cat['name']) ?></a></li>
                <?php endforeach; ?>
            </ul>
        </aside>
        ...
        <section class="products-section">
            <div class="products-header">
                ...
                <p class="products-count"><?= $product_count ?> product<?= $product_count != 1 ? 's' : '' ?></p>
            </div>
                    ...
                    <?php while($product = mysqli_fetch_assoc($products_result)): ?>
                        <a href="product-detail.php?id=<?= $product['id'] ?>" class="product-card">
                            <div class="product-image-wrapper">
                                ...
                                <img src="<?= htmlspecialchars($img) ?>" alt="<?= htmlspecialchars($product['name']) ?>" class="product-image">
            ...
            <div class="footer-columns">
                ...
                <div class="footer-column">
                    ...
                    <ul class="footer-links">
                        ...
                        <li><a href="my-hm.php">MY H&M</a></li>
    ...
    <script>
        ...
        // Side Panel Controls (same as in original file)
