...
$contacts = [];
$res = mysqli_query($conn, "SELECT * FROM contact_options ORDER BY id ASC");
if ($res) {
...
<head>
    ...
    <style>
        * {
        ...
        /* Hide the right section (category part) */
        .right-section {
            display: none;
        }
        
        /* Make left section full width since right section is hidden */
        .content-wrapper {
            display: block;
        }
        ...
        /* Hide social section and everything after it until FAQ */
        .social-section,
        ...
        /* Move breadcrumb - remove it from original position and reposition */
        .breadcrumb {
            display: block;
            order: 999; /* This will move it to the end if parent is flex */
            margin-top: 60px;
            margin-bottom: 40px;
            padding-top: 40px;
        ...
        /* Adjust container to allow reordering */
        .container {
            display: flex;
            flex-direction: column;
        }
        
        /* Ensure breadcrumb comes after left-section */
        .left-section {
            order: 1;
        }
    ...
    <div class="container">
        ...
        <div class="content-wrapper">
            ...
            <div class="left-section">
                ...
                <p>Our dedicated Customer Service Team are here to help! For Quicker assistance please explore our FAQ to find the information you need.</p>
                ...
                <?php foreach ($contacts as $contact): ?>
                    ...
                    <?php if (!empty($contact['availability'])): ?>
                        <p><?= htmlspecialchars($contact['availability']) ?></p>
                    <?php endif; ?>
                <?php endforeach; ?>
            ...
            <div class="right-section">
                ...
                <ul class="category-links">
                    <li><a href="#">SHOPPING AT H&M</a></li>
                    <li><a href="#">DELIVERY</a></li>
                    <li><a href="#">PAYMENTS</a></li>
                    <li><a href="#">RETURNS & REFUNDS</a></li>
                    <li><a href="#">GIFT CARDS</a></li>
                    <li><a href="#">PRODUCT & SIZE</a></li>
                    <li><a href="#">H&M MEMBERSHIP</a></li>
        ...
        <div class="faq-section">
            ...
            <div class="faq-item">
                <span>WHERE IS MY RETURN?</span>
            </div>
            <div class="faq-item">
                <span>I WANT TO RETURN</span>
            </div>
        ...
        <div class="faq-section" style="border-top: none;">
            ...
            <div class="faq-item">
                <span>CAREER AT H&M</span>
            </div>
        </div>

        <!-- Environmental Notice -->
        <div class="environmental-notice">
            All product returns come at an environmental cost and each returned package leaves a significant trail of emissions. H&M encourages you to be a contributor towards climate positive fashion. Kindly refer to our product details and size guide to avoid inconvenience of returns.
        </div>

        <!-- Privacy Notice -->
        <div class="privacy-notice">
            When you contact Customer Service your personal data will be processed in accordance with our <a href="#">Privacy Notice</a>.
        </div>
    </div>
