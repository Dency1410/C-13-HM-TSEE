...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!$hero_image && !empty($_POST['hero_image_url'])) {
        $hero_image = mysqli_real_escape_string($conn, $_POST['hero_image_url']);
    }

    $sql = "INSERT INTO investor_page (page_title, hero_image, contact_section_title, contact_name, contact_phone, contact_email)
            VALUES ('$page_title', '$hero_image', '$contact_section_title', '$contact_name', '$contact_phone', '$contact_email')";

    if (mysqli_query($conn, $sql)) {
        header("Location: manage_investor.php?success=Record+added+successfully!");
        exit;
    } else {
...
<head>
    ...
    <title>Add Investor Record - Admin</title>
...
<div class="main-content">
    <div class="top-bar">
        <div style="display:flex;align-items:center;gap:14px;">
            ...
            <h1>Add Investor Record</h1>
        </div>
        <?php include 'header.php'; ?>
    </div>

    <div class="form-card">
        <div class="form-card-title"><i class="fas fa-chart-line"></i> Investor Page Details</div>
        <?php if ($message): ?><div class="alert alert-danger"><?= $message ?></div><?php endif; ?>

        <form method="POST" enctype="multipart/form-data"  id="addInvestorForm">

            <!-- Page Title -->
            <div class="field-group">
                <label class="field-label">Page Title <span class="req">*</span></label>
                <input type="text" name="page_title" class="field-input" value="Investors" 
                       data-validation="required,alphabetic">
            ...
            <div class="image-group">
                ...
                <input type="file" name="hero_image_file" class="field-input" accept="image/*"
                       data-validation="required,filesize,filetype" data-filesize="5" data-filetype="jpg,jpeg,png,webp">
                ...
                <input type="text" name="hero_image_url" class="field-input" placeholder="https://..." data-validation="required">
            </div>
            ...
            <div class="field-group">
                ...
                <input type="text" name="contact_section_title" class="field-input" value="Contact" data-validation="required,alphabetic">
            ...
            <div class="field-group">
                ...
                <input type="text" name="contact_name" class="field-input" placeholder="e.g. Joseph Ahlberg" 
            ...
            <div class="two-col">
                <div class="field-group">
                    ...
                    <input type="text" name="contact_phone" class="field-input" placeholder="+46 8 7965500"
                ...
                <div class="field-group">
                    ...
                    <input type="email" name="contact_email" class="field-input" placeholder="info@hm.com"
            ...
            <div class="btn-row">
                <button type="submit" class="btn-publish"><i class="fas fa-plus"></i> Add Record</button>
