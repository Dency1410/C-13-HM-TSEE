...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $insert_ceo = "INSERT INTO ceos (name, title, subtitle, image, bio, status) 
                   VALUES ('$name', '$title', '$subtitle', '$imagePath', '$bio', '$status')";
    
    if (mysqli_query($conn, $insert_ceo)) {
...
<div class="main-content">
    ...
    <div class="form-card">
        <div class="form-card-title"><i class="fas fa-user-tie"></i> CEO Details</div>
        <?php if($message) echo "<div class='alert alert-info'>$message</div>"; ?>
        
        <form method="POST" enctype="multipart/form-data" novalidate id="addCeoForm">
            <div class="field-group">
                <label class="field-label">CEO Photo <span class="req">*</span></label>
            ...
            <div class="two-col">
                ...
                <div class="field-group">
                    ...
                    <input type="text" name="title" class="field-input" placeholder="e.g. CEO of H&M Group" 
            ...
            <div class="field-group">
                ...
                <textarea name="subtitle" class="field-input" rows="2" placeholder="Daniel Ervér, born in 1981..." data-validation="required" ></textarea>
                <small id="subtitle_error" class="small text-danger" style="display:none;"></small>
            </div>

            <div class="field-group">
                <label class="field-label">Detailed Bio</label>
                <textarea name="bio" class="field-input" rows="6" placeholder="Detailed paragraphs. Use double newlines for paragraphs." data-validation="required"></textarea>
                <small id="bio_error" class="small text-danger" style="display:none;"></small>
            </div>
            ...
            <div class="btn-row">
                <button type="submit" class="btn-publish"><i class="fas fa-plus"></i> Add CEO</button>
