...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    function uploadImg($fileKey, $uploadDir, $allowTypes) {
    ...
    $our_way_image = uploadImg('our_way_image', $uploadDir, $allowTypes);
    $col1_image    = uploadImg('col1_image', $uploadDir, $allowTypes);
    $col2_image    = uploadImg('col2_image', $uploadDir, $allowTypes);
    $col3_image    = uploadImg('col3_image', $uploadDir, $allowTypes);

    // Fallback to URL inputs if no file uploaded
    if (!$our_way_image) $our_way_image = mysqli_real_escape_string($conn, $_POST['our_way_image_url'] ?? '');
    if (!$col1_image)    $col1_image    = mysqli_real_escape_string($conn, $_POST['col1_image_url'] ?? '');
    if (!$col2_image)    $col2_image    = mysqli_real_escape_string($conn, $_POST['col2_image_url'] ?? '');
    if (!$col3_image)    $col3_image    = mysqli_real_escape_string($conn, $_POST['col3_image_url'] ?? '');

    $sql = "INSERT INTO about_us (section_key, hero_title, intro_title, intro_text,
            ...
            VALUES ('$section_key','$hero_title','$intro_title','$intro_text',
                '$stat1_number','$stat1_label','$stat2_number','$stat2_label',
                '$stat3_number','$stat3_label','$stat4_number','$stat4_label',
                '$stat_reference','$our_way_title','$our_way_desc','$our_way_image',
                '$col1_title','$col1_text','$col1_image',
                '$col2_title','$col2_text','$col2_image',
                '$col3_title','$col3_text','$col3_image')";

    if (mysqli_query($conn, $sql)) {
        header("Location: manage_about_us.php?success=Section+added+successfully!");
        exit;
    } else {
...
<head>
    ...
    <title>Add About Us Section - Admin</title>
...
<div class="main-content">
    ...
    <div class="form-card">
        <div class="form-card-title"><i class="fas fa-info-circle"></i> About Us Section Details</div>
        <?php if ($message): ?><div class="alert alert-danger"><?= $message ?></div><?php endif; ?>

        <form method="POST" enctype="multipart/form-data" novalidate id="addAboutUsForm">

            <!-- Basic -->
            <div class="two-col">
                <div class="field-group">
                    <label class="field-label">Section Key <span class="req">*</span></label>
                    <input type="text" name="section_key" class="field-input" placeholder="e.g. main" 
                ...
                <div class="field-group">
                    ...
                    <input type="text" name="hero_title" class="field-input" value="About us" 
            ...
            <!-- Intro -->
            <div class="section-divider">Introduction</div>
            <div class="field-group">
                <label class="field-label">Intro Title <span class="req">*</span></label>
                <textarea name="intro_title" class="field-input" rows="2" 
            ...
            <div class="four-col">
                <div class="field-group">
                    ...
                    <input type="text" name="stat1_number" class="field-input" placeholder="79"
                ...
                <div class="field-group">
                    ...
                    <input type="text" name="stat1_label" class="field-input" placeholder="markets (2024)"
                           data-validation="required">
                ...
                <div class="field-group">
                    ...
                    <input type="text" name="stat2_number" class="field-input" placeholder="140,000"
                           data-validation="required">
                ...
                <div class="field-group">
                    ...
                    <input type="text" name="stat2_label" class="field-input" placeholder="employees globally"
                           data-validation="required">
            ...
            <div class="four-col">
                <div class="field-group">
                    ...
                    <input type="text" name="stat3_number" class="field-input" placeholder="234"
                           data-validation="required">
                ...
                <div class="field-group">
                    ...
                    <input type="text" name="stat3_label" class="field-input" placeholder="billion SEK in net sales"
                           data-validation="required">
                ...
                <div class="field-group">
                    ...
                    <input type="text" name="stat4_number" class="field-input" placeholder="89%"
                           data-validation="required">
                ...
                <div class="field-group">
                    ...
                    <input type="text" name="stat4_label" class="field-input" placeholder="recycled materials"
                           data-validation="required">
            ...
            <div class="field-group">
                ...
                <input type="text" name="stat_reference" class="field-input" placeholder="Figures from our Annual and sustainability report 2024."
            ...
            <div class="two-col">
                <div class="field-group">
                    ...
                    <input type="text" name="our_way_title" class="field-input" value="Our way"
                           data-validation="required,min" data-min="3">
                ...
                <div class="field-group">
                    ...
                    <div class="image-group">
                        ...
                        <label style="margin-top:8px;">OR Image URL</label>
                        <input type="text" name="our_way_image_url" class="field-input" placeholder="https://...">
            ...
            <div class="three-col">
                ...
                <div>
                    <div class="field-group">
                        ...
                        <input type="text" name="col1_title" class="field-input" placeholder="OUR HISTORY"
                               data-validation="required,min" data-min="3">
                    ...
                    <div class="image-group">
                        <label>Card 1 Image Upload</label>
                        ...
                        <input type="text" name="col1_image_url" class="field-input" placeholder="https://...">
                ...
                <div>
                    <div class="field-group">
                        ...
                        <input type="text" name="col2_title" class="field-input" placeholder="OUR VALUES"
                               data-validation="required,min" data-min="3">
                    ...
                    <div class="image-group">
                        <label>Card 2 Image Upload</label>
                        ...
                        <label style="margin-top:8px;">OR URL</label>
                        <input type="text" name="col2_image_url" class="field-input" placeholder="https://...">
                ...
                <div>
                    <div class="field-group">
                        ...
                        <input type="text" name="col3_title" class="field-input" placeholder="INCLUSION & DIVERSITY"
                               data-validation="required,min" data-min="3">
                    ...
                    <div class="image-group">
                        <label>Card 3 Image Upload</label>
                        ...
                        <label style="margin-top:8px;">OR URL</label>
                        <input type="text" name="col3_image_url" class="field-input" placeholder="https://...">
            ...
            <div class="btn-row">
                <button type="submit" class="btn-publish"><i class="fas fa-plus"></i> Add Section</button>
